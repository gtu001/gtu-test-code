...
public class CaffeineCacheApp implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        customerService.getCustomer(1l); // No hit , since this is the first
                                         // request.
        customerService.getCustomer(2l); // No hit , since this is the first
                                         // request.
        customerService.getCustomer(1l); // hit , since it is already in the
                                         // cache.
        customerService.getCustomer(1l); // hit , since it is already in the
                                         // cache.
        customerService.getCustomer(1l); // hit , since it is already in the
