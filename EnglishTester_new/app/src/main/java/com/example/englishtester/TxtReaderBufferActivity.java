...
//                scrollViewYHolder.recordY(this.getTitle().toString(), getScrollView1());
    ...
    public String getDtoFileName() {
        return txtBufferViewerMainHandler.getDto().getFileName().toString();
    }
...
//            myService = null;
    ...
    public void moveToBookmarkPage() {
        ...
        if (!(txtBufferViewerMainHandler != null && txtBufferViewerMainHandler.isInitDone())) {
            Toast.makeText(this, "請先開啟Pdf!", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public String getCurrentTitle(int page_index) {
        return txtBufferViewerMainHandler.getCurrentTitle(page_index);
    }
