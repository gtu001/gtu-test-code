...
//            myService = null;
    ...
    public void moveToBookmarkPage() {
        ...
        if (!moveHandler.validateInitOk()) {
            Toast.makeText(MobiReaderMobiActivity.this, "請先開啟Epub!", Toast.LENGTH_SHORT).show();
            return;
        }
...
//                {file_name=Everybody Lies Big Data, New Data, and What the Internet - Seth Stephens-Davidowitz[4], bookmark_type=2, insert_date=496398149}
        ...
        private void initReference() {
            ...
            List<Map<String, Object>> lst = DBUtil.queryBySQL_realType(sql, new String[0], MobiReaderMobiActivity.this);
        ...
        private void showDlg() {
            if (lst4Adapter.isEmpty()) {
                Toast.makeText(MobiReaderMobiActivity.this, "尚無書籤紀錄", Toast.LENGTH_SHORT).show();
                return;
            }

            SimpleAdapter aryAdapter = new SimpleAdapter(MobiReaderMobiActivity.this, lst4Adapter,// 資料來源
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(MobiReaderMobiActivity.this);
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            Toast.makeText(MobiReaderMobiActivity.this, "跳至章節 " + pos + " : " + dtlPos + " : Page : " + (row.page_index + 1), Toast.LENGTH_SHORT).show();
