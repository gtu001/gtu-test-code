...
public class Mp3PlayerHandler {
    ...
    private Mp3StoreStatusThread mStoreStatusThread;
    ...
    public void applyOf(String url, Context context) {
        try {
            ...
            mStoreStatusThread = new Mp3StoreStatusThread(mMyReplayListObj, context);
    ...
    public static class MyReplayListObj implements MediaPlayer.OnCompletionListener {
        ...
        public int getMp3PlayerHandlerCurrentPosition() {
            return mp3PlayerHandler.getCurrentPosition();
        }
    }
