...
<script type="text/javascript">
	...
	function checkAdprjidIsOk(adprjid){ //確認廣告id是否可用
		var data = $.ajax({
			...
			data : {"adprjid" : adprjid},
			async : false,
			dataType : "JSON",
			error : function(jqXHR, textStatus, errorThrown) {
				console.log("廣告ID確認失敗 : " + jqXHR + ", " + textStatus + ", " + errorThrown);
			}
		}).responseJSON;
		if(data){
			if(data.result == true){
						...
						<div class="stepper-steps col-md-9 col-12">
							...
							<div class="stepper-step" v-if="adBlock=='首頁輪播'&&step!==1">
								<div class="stepper-stepContent"
									...
									<h5>
										<span class="stepper-stepMarker">3</span> 選擇客群
									</h5>
								</div>
							</div>
						</div>
								...
								<div class="card-body">
									<div class="custom-controls-stacked">
										<label class="custom-control custom-radio"
											...
											<input :value="business.blockcode" type="radio" class="custom-control-input" v-model="adBlock" name="adBlockCheck"> 
							...
							<div class="card mb-4 bg-light">
								...
								<div class="card-body">
									<form>
										...
										<div class="form-group row">
											<label for="isDefault"
												class="col-sm-4 col-form-label">是否為預設廣告<br> <small>(請確認default廣告日期)</small></label>
											<div class="col-sm-8">
