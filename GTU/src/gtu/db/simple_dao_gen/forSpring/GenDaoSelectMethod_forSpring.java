...
public class GenDaoSelectMethod_forSpring {
    ...
    private String getQueryMethod(String sql, List<String> pkList) {
        StringBuilder sb = new StringBuilder();
        sb.append("     public List<Map<String,Object>> query(Map<String,Object> pkMap, DataSource dataSource){     \n");
        sb.append("        try {                                                                                    \n");
        ...
        sb.append("            };                                                                                   \n");
        sb.append("            return template.queryForList(sql, params);                                           \n");
