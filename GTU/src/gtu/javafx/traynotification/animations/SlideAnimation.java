...
import gtu.javafx.traynotification.CustomStage;
...
public class SlideAnimation implements TrayAnimation {
    ...
    public SlideAnimation(CustomStage customStage) {
        ...
        // It wouldn't allow me to play embedded animations so I had to create
        // two separate
    ...
    private Timeline setupShowAnimation() {
        ...
        // Animates the Tray onto the screen and interpolates at a tangent for
        // 300 millis
        ...
        // Increases the opacity to fully visible whilst moving in the space of
        // 1000 millis
    ...
    private Timeline setupDismissAnimation() {
        ...
        // The destination X location for the stage. Which is off the users
        // screen
