...
/**
 * An abstract base class for subclasses which decode IBM double byte ebcdic
 * host encodings such as ibm code pages 933, 935, 937,... etc
 *
 */
            ...
            while (sp < sl) {
                ...
                if (b1 == SO) { // Shift out
                    ...
                    if (currentState == SBCS) {
                        ...
                        if ((b1 != 0x40 || b2 != 0x40) && (b2 < 0x41 || b2 > 0xfe)) {
                        ...
                        // 使用自訂字
                        outputChar = remapping((char) v, outputChar);
                    }
                    if (outputChar == '\uFFFD')
