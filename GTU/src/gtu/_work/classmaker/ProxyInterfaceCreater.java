...
public class ProxyInterfaceCreater {

    /**
     * @param args
     */
    public static void main(String[] args) {
        ProxyInterfaceCreater.newInstance(SelectItem.class).execute();
    }

    private ProxyInterfaceCreater(Class<?> clz) {
        this.clz = clz;
    }

    public ProxyInterfaceCreater execute() {
    ...
    static class AccessType {
        ...
        AccessType(Method method) {
            ...
            if (Modifier.isSynchronized(modifier)) {
                // syncType = "synchronized";//介面不需要 synchronized
                syncType = "";
            }
    ...
    public static ProxyInterfaceCreater newInstance(Class<?> clz) {
        return new ProxyInterfaceCreater(clz);
    }
