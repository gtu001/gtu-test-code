...
import gtu.html.simple.bootstrap.BootstrapDivSimpleCreater;
...
public class BootstrapDivSimpleCreaterUI extends JFrame {
    ...
    private PropertiesUtilBean config = new PropertiesUtilBean(BootstrapDivSimpleCreaterUI.class);
    ...
    public static void main(String[] args) {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    BootstrapDivSimpleCreaterUI frame = new BootstrapDivSimpleCreaterUI();
     ...
     * Create the frame.
     */
    public BootstrapDivSimpleCreaterUI() {
    ...
    private void applyAllEvents() {
        ...
        swingUtil.addActionHex("saveConfigBtn.click", new Action() {
            @Override
            public void action(EventObject evt) throws Exception {
                config.reflectSetConfig(BootstrapDivSimpleCreaterUI.this);
                config.store();
