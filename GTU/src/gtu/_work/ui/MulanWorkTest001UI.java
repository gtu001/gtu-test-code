...
public class MulanWorkTest001UI extends JFrame {
    ...
    public static void main(String[] args) {
        if (!JFrameUtil.lockInstance_delable(MulanWorkTest001UI.class)) {
            return;
        }
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    MulanWorkTest001UI frame = new MulanWorkTest001UI();
