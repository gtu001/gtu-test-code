 ...
 * @author Troy
 */
public class LoadJspCheckTag {

    /** 讀取目錄 */
    private String dirPath = "C:/workspace/backup/demo1011/demo1011-web/src/main/webapp";

    /** 匯出目錄 */
    private static final String EXPORT_FILE_PATH = System.getProperty("user.home") + "\\Desktop\\Edit1.txt";

    /** 副檔名 */
    private String subFileName = ".xhtml";
    ...
    public static LoadJspCheckTag newInstance() {
        return new LoadJspCheckTag();
    }

    public LoadJspCheckTag dirPath(String dirPath) {
        this.dirPath = dirPath;
        return this;
    }

    public LoadJspCheckTag subFileName(String subFileName) {
    ...
    public LoadJspCheckTag writeLogFile(boolean writeLogFile) {
    ...
    final Pattern startTagPattern = Pattern.compile("^<(\\w+:?\\w+)\\s.*$");
