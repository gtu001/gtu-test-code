 ...
 * @author gtu001
 */
public class WorkTimesheetProduce_witra {
    private static SimpleDateFormat BASE_SDF = new SimpleDateFormat("yyyyMMdd");
    private final static int BUFFER_DAY = 3;//超時緩衝日數
    private final static String START_TIME = "09:30";//上班基準時間
    private final static String END_TIME = "1830";//下班基準時間
    ...
    public static void main(String[] args) throws ParseException {
        WorkTimesheetProduce_witra test = new WorkTimesheetProduce_witra();
        
        Map<String,String> specialHoildayMap = new HashMap<String,String>();
        specialHoildayMap.put("20150619", "端午節");
