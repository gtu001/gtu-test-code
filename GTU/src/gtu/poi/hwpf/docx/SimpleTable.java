...
public class SimpleTable {
    ...
    public static void createSimpleTable() throws Exception {
        ...
        FileOutputStream out = new FileOutputStream(new File(FileUtil.DESKTOP_DIR, "simpleTable.docx"));
        doc.write(out);
        out.close();
    }
    ...
    public static void createStyledTable() throws Exception {
        ...
        // write the file
        FileOutputStream out = new FileOutputStream(new File(FileUtil.DESKTOP_DIR, "styledTable.docx"));
        doc.write(out);
        out.close();
    }
