...
public class NetTool {
    ...
    private static final NetTool _INST = new NetTool();

    private List<String> ipLst = new ArrayList<String>();
    ...
    public InetAddress getServerIP(String name) {
        try {
