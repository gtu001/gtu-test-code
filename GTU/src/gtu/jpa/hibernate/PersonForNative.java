...
//      )
public class PersonForNative implements Serializable{
...
//    long id;
    ...
    public static void main(String[] args){
        PersonForNative t = new PersonForNative();
        String siteId = "64000";
        siteId = StringUtils.substring(siteId, 0, 5);
        siteId = StringUtils.rightPad(siteId, 8, '0');
        System.out.println(t.getEmptySpace(8, siteId)); 
        System.out.println("done...");
    }

    public String writeOver() {
        Object[] vals = new Object[] { getEmptySpace(10, StringUtils.leftPad(personid, 10, '0')), //
                getEmptySpace(7, StringUtils.leftPad(birthYyymmdd, 7, '0')), //
                getEmptySpace(5, StringUtils.substring(StringUtils.rightPad(siteId, 8, '0'), 0, 5)), //
                getEmptySpace(2, StringUtils.leftPad(String.valueOf(count), 2, '0')), //
        };
        return Joiner.on(",").join(vals);
    }

    public String writeOne() {
        Object[] vals = new Object[] { getEmptySpace(8, StringUtils.leftPad(siteId, 8, '0')), //
                getEmptySpace(10, StringUtils.leftPad(personid, 10, '0')), //
                getEmptySpace(7, StringUtils.leftPad(birthYyymmdd, 7, '0')), //
                getEmptySpace(2, StringUtils.leftPad(String.valueOf(count), 2, '0')), //
        };
        return Joiner.on(",").join(vals);
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PersonForNative other = (PersonForNative) obj;
        if (personid == null) {
