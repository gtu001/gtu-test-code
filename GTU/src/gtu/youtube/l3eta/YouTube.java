...
public class YouTube {
    /*
     * Does not always download, retrying after a couple mins or 30 seconds
     * sometimes helps
     */
    ...
    // public static final HashMap<Integer, String> FILE_TYPES = new
    ...
    static {
        ...
        /*
         * FILE_TYPES.put(36, "3GP_240p"); FILE_TYPES.put(13, "3GP_144p");
         * FILE_TYPES.put(17, "3GP_144p"); FILE_TYPES.put(5, "FLV_240p");
         * FILE_TYPES.put(6, "FLV_270p"); FILE_TYPES.put(34, "FLV_360p");
         * FILE_TYPES.put(35, "FLV_480p"); FILE_TYPES.put(18, "MP4_(Max 480p)");
         * FILE_TYPES.put(22, "MP4_720p"); FILE_TYPES.put(37, "MP4_1080p");
         * FILE_TYPES.put(160, "MP4_144p (Video Only)"); FILE_TYPES.put(133,
         * "MP4_240p (Video Only)"); FILE_TYPES.put(134,
         * "MP4_360p (Video Only)"); FILE_TYPES.put(135,
         * "MP4_480p (Video Only)"); FILE_TYPES.put(136,
         * "MP4_720p (Video Only)"); FILE_TYPES.put(137,
         * "MP4_1080p (Video Only)"); FILE_TYPES.put(139,
         * "M4A_48Kbps (Video Only)"); FILE_TYPES.put(140,
         * "M4A_128kbps (Audio Only)"); FILE_TYPES.put(141,
         * "M4A_256kbps (Audio Only)"); FILE_TYPES.put(38, "MP4");
         * FILE_TYPES.put(83, "MP4_3D 240p"); FILE_TYPES.put(82, "MP4_3D 360p");
         * FILE_TYPES.put(85, "MP4_3D 520p"); FILE_TYPES.put(84, "MP4_3D 720p");
         * FILE_TYPES.put(43, "WEBM_360p"); FILE_TYPES.put(44, "WEBM_480p");
         * FILE_TYPES.put(45, "WEBM_720p"); FILE_TYPES.put(46, "WEBM_1080p");
         * FILE_TYPES.put(100, "WEBM_3D 360p"); FILE_TYPES.put(101,
         * "WEBM_3D 360p"); FILE_TYPES.put(102, "WEBM_3D 720p");
         */
    }

    public static void main(String[] args) {
        downloadUrl("http://m.youtube.com/watch?v=OwJPPaEyqhI");
        System.out.println("done...");
    }

    public static String STORAGE = FileUtil.DESKTOP_PATH;
    /**
    ...
    public static void download(String id) {
        ...
        if (flvUrls != null) {
            ...
            for (String flv : flvUrls) {
                int tag = getTag(flv);
                if (tag == TARGET_QUALITY) {// Download only target to avoid
                                            // issues
    ...
    private static String[] getFLVFormatUrls(String[] urls) {
        ...
        Collections.sort(u, new Comparator<String>() {// my first attempt at
                                                      // actually using this
                                                      // class lolol
    ...
    public static String getSaveFilePath(String name) {// TODO remove invalid
                                                       // chars from file name
