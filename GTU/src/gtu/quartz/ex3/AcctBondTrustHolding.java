...
@Entity
@Table(name = "ACCT_BOND_TRUST_HOLDING")
public class AcctBondTrustHolding {
    ...
    public AcctBondTrustHolding() {

    }

    public AcctBondTrustHolding(String bondId, String custId, String tstAcctNo, String contractNoteNbr,
