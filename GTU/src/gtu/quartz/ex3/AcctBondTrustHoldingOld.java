...
@Entity
@Table(name = "ACCT_BOND_TRUST_HOLDING_OLD")
public class AcctBondTrustHoldingOld {
    ...
    public AcctBondTrustHoldingOld() {

    }

    public AcctBondTrustHoldingOld(String bondId, String custId, String tstAcctNo, String contractNoteNbr,
            String custodianInstitute, BigDecimal tmpPrinciplePayment, BigDecimal redeemBranchCode,
