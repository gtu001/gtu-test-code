 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://localhost/sample", wsdlLocation = "http://localhost:8088/calcuator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://localhost/sample", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8088/calcuator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://localhost/sample", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://localhost/sample", "CalculatorPort"), Calculator.class, features);
    }
