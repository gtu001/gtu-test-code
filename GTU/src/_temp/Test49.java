...
public class Test49 {
    ...
    private static final String TAG = Test49.class.getSimpleName();

    public static void main(String[] args) throws InterruptedException, IOException {
        Test49 t = new Test49();

        File file = new File("C:/Users/wistronits/Desktop/xxxxxxxxxxxxxxxxxxx.txt");
        String content = FileUtil.loadFromFile(file, "utf8");
        String result = t.getFromContent(content, false, "</script>");
    ...
    protected String getFromFile(File file, boolean isPure, String checkStr) {
        String content = FileUtil.loadFromFile(file, getEncoding());
