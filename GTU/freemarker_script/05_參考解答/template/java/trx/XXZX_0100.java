...
public class ${main_action_clz} extends UCBean {
    ...
    public ResponseContext doQuery(RequestContext req) {
        try {
            ...
            MessageUtil.setReturnMessage(msg, ReturnCode.DATA_NOT_FOUND, "¬dµL¸ê®Æ");
            ...
            if (me.getRootException() == null) {
                ...
                if (me.getRootException() instanceof OverCountLimitException) {
                    MessageUtil.setReturnMessage(msg, me, req, ReturnCode.ERROR_MODULE, "¬d¸ßµ§¼Æ¶W¥X¨t²Î­­¨î¡A½ÐÁY¤p¬d¸ß½d³ò");
                } else {
                    MessageUtil.setReturnMessage(msg, me, req, ReturnCode.ERROR_MODULE, "¬d¸ß¥¢±Ñ");
                }
            }
        } catch (Exception e) {
            log.error("¬d¸ß¥¢±Ñ", e);
            MessageUtil.setReturnMessage(msg, e, req, ReturnCode.ERROR, "¬d¸ß¥¢±Ñ");
        }
