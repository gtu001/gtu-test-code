...
/*
    ...
    <input style="background:url(../common/images/select--bg_03.png) no-repeat right center" class=codeno 
    	   name=EdorType id=EdorType
           onclick="return showCodeList('edortype',[this,EdorTypeName],[0,1]);"
           ondblclick="return showCodeList('edortype',[this,EdorTypeName],[0,1]);"
           onkeyup="return showCodeListKey('edortype',[this,EdorTypeName],[0,1]);">
    <input class=codename name=EdorTypeName id=EdorTypeName readonly>
*/
	...
	function setGridMultiline(){
	    var sqlresourcename ="bq.ImageQuerySql";
	    var sqlid3 = "ImageQuerySql3";
	    var strSQL = wrapSql(sqlresourcename,sqlid3,[fm.BussNo.value],"common");
	    var arrResult = easyExecSql(strSQL);
	    if (arrResult){
	        document.all("otherDiv").style.display='';
	        displayMultiline(arrResult, OtherGrid);
	    }
	}

	
	function saveBeforeMessage() {
		...
		var iTop = (window.screen.availHeight - iHeight) / 2; 
		var iLeft = (window.screen.availWidth - iWidth) / 2; 
		showInfo = window.open(urlStr, window,
				"status:no;help:0;close:0;dialogWidth:250px;dialogHeight:250px");
		showInfo.focus();
	}
