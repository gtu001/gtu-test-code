...
import com.example.gtuandroid.sub.AnimDownloadProgressButton;

public class AnimDownloadProgressButtonActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_anim_download_progress_btn);
